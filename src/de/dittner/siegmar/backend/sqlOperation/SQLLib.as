...
public class SQLLib extends WalterProxy {
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/CreateFileHeaderTbl.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/CreateFileBodyTbl.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/CreatePhotoTbl.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/InsertFileHeader.sql", mimeType="application/octet-stream")]
	private static const InsertFileHeaderClass:Class;
	public static const INSERT_FILE_HEADER:String = new InsertFileHeaderClass();

	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/InsertFileBody.sql", mimeType="application/octet-stream")]
	private static const InsertFileBodyClass:Class;
	public static const INSERT_FILE_BODY:String = new InsertFileBodyClass();

	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/InsertPhoto.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/UpdateFileHeader.sql", mimeType="application/octet-stream")]
	private static const UpdateFileHeaderClass:Class;
	public static const UPDATE_FILE_HEADER:String = new UpdateFileHeaderClass();

	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/UpdateFileBody.sql", mimeType="application/octet-stream")]
	private static const UpdateFileBodyClass:Class;
	public static const UPDATE_FILE_BODY:String = new UpdateFileBodyClass();

	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/UpdatePhoto.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/DeleteFileHeaderByFileID.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/DeleteFileBodyByFileID.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/DeletePhotoByID.sql", mimeType="application/octet-stream")]
	private static const DeletePhotoByIDClass:Class;
	public static const DELETE_PHOTO_BY_ID:String = new DeletePhotoByIDClass();

	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/DeletePhotoByFileID.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectFileHeaders.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectFileHeadersByType.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectFavoriteFileHeaders.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectAllFileHeaders.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectFileBody.sql", mimeType="application/octet-stream")]
	private static const SelectFileBodyClass:Class;
	public static const SELECT_FILE_BODY:String = new SelectFileBodyClass();

	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectPhotoBytes.sql", mimeType="application/octet-stream")]
	private static const SelectPhotoClass:Class;
	public static const SELECT_PHOTO:String = new SelectPhotoClass();

	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectPhotoPreview.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/siegmar/backend/sqlOperation/sql/SelectPhotosInfo.sql", mimeType="application/octet-stream")]
