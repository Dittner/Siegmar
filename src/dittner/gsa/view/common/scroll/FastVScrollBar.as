...
public class FastVScrollBar extends VScrollBar {
	override mx_internal function mouseWheelHandler(event:MouseEvent):void {
		...
		vp.verticalScrollPosition += vp.height / 3 * direction;
	...
	override public function changeValueByStep(increase:Boolean = true):void {
		...
		var newValue:Number = (increase) ? value + 100 * stepSize : value - 100 * stepSize;
		setValue(newValue);
		if (value != prevValue)
